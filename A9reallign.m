...
hs = 489e-6;%microns current substrate 
...
A9master = outerjoin(Mtable,Etable,'MergeKeys',true); %join on time collumn, hence rounding to nearest 10 s
% UNCOMMENT THIS TO MAKE A CSV FILE
%writetable(A9master,'A9Stress.csv')
...
for i = hCycIndex'
    ...
    thisArr = table2array(A9master(thisCycle,:));
...
% UNCOMMENT THIS TO MAKE A CSV FILE
%writetable(chrono,'A9Chronology.csv')
