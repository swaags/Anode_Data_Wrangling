...
figure(5)
cTenths = chrono(find(chrono.c_rate<.25),{'cycle_number','dischgcap_end_mAhg'});
%Adjust because reasons
cTenths = cTenths(2:end,:);
...
% UNCOMMENT THIS TO MAKE A CSV FILE
%writetable(chrono,'Baseline1Chronology.csv')
